...
class PersonalInfosControllerTest < ActionController::TestCase
  ...
  test "should create personal_info" do
    assert_difference('PersonalInfo.count') do
      post :create, personal_info: { heigth: @personal_info.heigth, person_id: @personal_info.person_id, weigth: @personal_info.weigth }
    end
  ...
  test "should update personal_info" do
    patch :update, id: @personal_info, personal_info: { heigth: @personal_info.heigth, person_id: @personal_info.person_id, weigth: @personal_info.weigth }
    assert_redirected_to personal_info_path(assigns(:personal_info))
  end
